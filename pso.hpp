...
namespace pso {
  ...
  Particle<N> pso(const arr<N>& lower_bound,const arr<N>& upper_bound,const prob<N>& problem,const size_t max_iter=1000,const std::array<double,2> c={0.2,0.2},const std::array<double,2> iw={0.1,0.01},const double mu=0.1){
